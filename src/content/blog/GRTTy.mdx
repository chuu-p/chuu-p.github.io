...
description: 'A quickstart template for building a gRPC Rust React Typescript fullstack application.'
tags:
  - Rust
  - Dev
  - Typescript
...
**_NOTE:_** You can find the code for a working full stack example repository [here](https://github.com/chuu-p/GRTTy)

<GithubCard repo='chuu-p/GRTTy' />
...
~~~proto title="example-spec/example.proto"
syntax = "proto3";
...
~~~ts title="example/vite.config.ts"
...
~~~toml title="example-api/cargo.toml"
[package]
name = "example-api"
version = "0.1.0"
edition = "2021"
...
~~~rust title="example-api/build.rs"
...
~~~rust title="example-api/src/main.rs"
use std::env;
use std::path::Path;
...
~~~sql title="example-api/migrations/.../down.sql"
...
~~~rust title="example-api/src/models.rs"
...
~~~rust title="example-api/src/schema.rs"
...
~~~rust title="example-api/tests/health_check.rs"
use diesel::prelude::*;
...
~~~ts title="example/src/App.test.ts"
